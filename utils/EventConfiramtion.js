...
exports.mailerConfiramtion = async (data) => {
    ...
    <head>
        ...
        <title>Otp</title>
        <meta name="description" content="Event confirmation">
        <style type="text/css">
            a:hover 
            {
                                        ...
                                        <td style="padding:0 35px;">
                                            ...
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              ...
                                              <tr>
                                                <td>
                                                    <br>
                                                    <center><a href=${"//" + data.link} style="background-color: #7b38d8;padding: 10px;color: #ffffff;text-align: center;">Click me!</a></center>
                                                  <br>
                                                  <br>
